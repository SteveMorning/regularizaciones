...
function dibujarpinchito(fields, element) {
	...
	let icoEspera =
		"https://img.icons8.com/?size=100&id=z8VDNr3xBWo8&format=png&color=000000";
		...
		if (obj !== null) {
			...
			switch (element[2]) {
				case "0": // #######################  TOMADO POR MI  #######################
					...
					$(obj).attr("data-original-title", "Tomado por mi.");
				...
				case "1": // #######################  TOMADO   #######################
					...
					$(obj).attr("data-original-title", "Regularizacion Tomada");
					$(obj).attr("data-content", mensaje);
				...
				case "2":
					...
					$(obj).attr("data-original-title", "Regularizacion en Pendiente");
					// $(obj).attr("data-content", mensaje);
					break;
				case "3":
					// #######################  En Espera   #######################
					...
					$(obj).attr("data-original-title", "Regularizacion en Espera");
					// $(obj).attr("data-content", mensaje);
					break;
				case "4":
					// #######################  RESUELTO    #######################
					...
					// $(obj).attr("data-original-title", "Regularizacion Resuelta");
					// $(obj).attr("data-content", mensaje);
					break;
				default: // #######################  DEFAULT   #######################
					$(obj).css("border-color", "#0d6efd");
					$(obj).css("background-color", "#cfe2ff");
					$(obj).attr("src", icoDefault);
					// $(obj).attr("data-original-title", "xxxx");
					break;
			}
		}
	}
