...
<div class="row flex-nowrap d-none">
	<div class="col-12 ">
		<div class="row ml-1">
			<!-- ############## Regiones ############### -->
			...
			<div class="ml-1">
				<button type=" button" id="btnLimpiarFiltros" onclick="limpiarFiltrosListado()"
					class="btn btn-danger btn-sm ">Limpiar Filtros</button>
			</div>
		</div>
	</div>
</div>
	...
	<div class="col-4">
		<div class="row ml-1 d-flex justify-content-around">
			...
			<div class="ml-1">
				<!-- <label for="filtraEquipo" class="form-label mb-0">Fecha de Carga</label> -->
				<input class="form-control  border border-dark p-0 m-0" id="filtraEquipo"
					style="height:fit-content; height:29px; width: 120px; " type="date" placeholder="Fecha de Carga"
					data-toggle="popover" title="Fecha de Carga">
			</div>
		</div>
	</div>
