	...
	<div class="col-9">
		<div class="row">
			...
			<div class="col-2 text-right">
				<button type="button" id="btnAplicarFiltros" class="btn btn-primary btn-sm">Aplicar Filtros</button>
			</div>
		...
		<div class="row mt-1">
			...
			<div class="col-2 text-right">
				<button type=" button" id="btnLimpiarFiltros" class="btn btn-danger btn-sm">Limpiar Filtros</button>
			</div>
		</div>
	</div>
	<div class="col-3 text-center " style="max-width: fit-content;">
		<!-- ############## Mostrar / Ocultar   ############### -->
		<div class="alert alert-info  text-center p-0 m-0 mr-1">
			<h6>Mostrar / Ocultar Campos</h6>
			<hr class="m-1">
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="checkbox" onclick="mostrarOcultarCampos(this)" conid="inlineCheckbox1" value="campoAntig" checked>
				<label class="form-check-label" for="inlineCheckbox1">Antiguedad</label>
			</div>
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="checkbox" id="inlineCheckbox2" onclick="mostrarOcultarCampos(this)" value="campoAntigFlag" checked>
				<label class="form-check-label" for="inlineCheckbox2">Antig Flags</label>
			</div>
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="checkbox" id="inlineCheckbox3" onclick="mostrarOcultarCampos(this)" value="campoIngresos" checked>
